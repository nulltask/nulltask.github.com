                ...
                $this.createObject = (function() {
                    ...
                    return function(options) {
						...
						*/
						...
						elem.innerText = this.options.char[Math.floor(Math.random() * this.options.char.length)];
						elem.style.position = 'absolute';
						elem.style.fontSize = size * 5 + 'px';
						elem.style.opacity = .66;
						elem.style.fontWeight = 'bold';
						elem.style.color = '#' + color.toString(16);
						document.body.appendChild(elem);
						o = new THREE.Particle(new THREE.ParticleDOMMaterial(elem));
                        o.name = options.name;
